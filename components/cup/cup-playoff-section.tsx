...
export function CupPlayoffSection({
  ...
  const winners = matches.filter((m) => m.winnerId != null).map((m) => m.winnerId!);

  return (
    <div className="card p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-muted uppercase tracking-wider">Playoff Round</h3>
        {allCompleted && (
