...
export function Sidebar({ items, footer }: SidebarProps) {
  ...
  return (
    <aside className="w-[232px] shrink-0 bg-panel border-r border-line flex flex-col min-h-screen sticky top-0 h-screen">
            ...
            <Link
              ...
              className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13.5px] font-medium transition-colors ${
                active
                  ...
                  : "text-ink-2 hover:bg-brand-50 hover:text-ink"
              }`}
            >
