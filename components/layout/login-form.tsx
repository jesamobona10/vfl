        ...
        <div className="flex gap-1 bg-surface-2 rounded-lg p-1 mb-6">
          <button
            ...
            className={`flex-1 py-2 text-xs sm:text-sm font-medium rounded-md transition-colors ${
              mode === "team" ? "bg-surface shadow-sm text-text" : "text-muted hover:text-text"
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-xs sm:text-sm font-medium rounded-md transition-colors ${
              mode === "player" ? "bg-surface shadow-sm text-text" : "text-muted hover:text-text"
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-xs sm:text-sm font-medium rounded-md transition-colors ${
              mode === "admin" ? "bg-surface shadow-sm text-text" : "text-muted hover:text-text"
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-xs sm:text-sm font-medium rounded-md transition-colors ${
              mode === "org" ? "bg-surface shadow-sm text-text" : "text-muted hover:text-text"
            }`}
          >
            <Shield size={16} className="inline mr-1" />
            Organization
