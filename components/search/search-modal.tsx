...
export function SearchModal({ isOpen, onClose }: SearchModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-sm border border-line w-full max-w-2xl max-h-[70vh] flex flex-col relative">
        ...
        <div className="flex-1 overflow-y-auto p-2">
            ...
            <>
              ...
              {results.map((r, i) => (
                ...
                >
                  ...
                  <div className="text-xs text-muted shrink-0 text-right">{r.meta}</div>
                </button>
              ))}
            </>
          )}
          ...
          {!query && (
            <div className="flex flex-col items-center justify-center py-12 text-muted">
              ...
              <p className="text-xs mt-1">Search across teams, players, and fixtures</p>
            </div>
          )}
        </div>
      </div>
