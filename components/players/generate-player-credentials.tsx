    ...
    <div className="card p-5 space-y-4 border-l-4 border-l-brand">
      ...
      <div>
        ...
        <p className="text-sm text-muted">
          ...
          Format: <code className="text-xs bg-bg px-1 rounded">PLAYERNAME_TEAMNAME_001</code> /{" "}
      ...
      {summary && (
        <div className="bg-brand/10 rounded-lg p-4 text-sm space-y-2">
          ...
          <p>
            Created: {summary.created} &middot; Regenerated: {summary.regenerated} &middot; Skipped:{" "}
            {summary.skipped}
            {summary.failed > 0 && (
              <>
                {" "}
