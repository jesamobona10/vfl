...
export function PlayerStats() {
  ...
  const averageRating =
    totalPlayers === 0
      ? 0
      : Number((players.reduce((sum, p) => sum + p.rating, 0) / totalPlayers).toFixed(1));
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="card p-4 border border-line bg-surface">
          <div className="flex items-start gap-3 text-muted mb-3">
            <TrendingUp size={20} />
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-muted">Avg rating</p>
        ...
        <div className="card p-4 border border-line bg-surface">
          <div className="flex items-start gap-3 text-muted mb-3">
            <Trophy size={20} />
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-muted">Total goals</p>
        ...
        <div className="card p-4 border border-line bg-surface">
          <div className="flex items-start gap-3 text-muted mb-3">
            <Crosshair size={20} />
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-muted">Teams</p>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="card p-4 border border-line bg-surface">
          <p className="text-xs uppercase tracking-[0.2em] text-muted mb-3">Leading performer</p>
        ...
        <div className="card p-4 border border-line bg-surface">
          <p className="text-xs uppercase tracking-[0.2em] text-muted mb-3">Report actions</p>
