  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl p-6 w-full max-w-md relative shadow-lg">
        ...
        <h2 className="text-lg font-bold mb-4">{isEdit ? "Edit Player" : "Add Player"}</h2>
        ...
        {showConfirm && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-60">
            <div className="bg-white rounded-xl shadow-sm border border-line p-6 max-w-sm">
              <h3 className="font-bold mb-2">Confirm Transfer</h3>
              <p className="mb-4 text-sm">
                You&apos;re about to transfer this player from{" "}
                <strong>
                  {teams.find((t) => String(t.id) === originalTeamId)?.name || "Unknown"}
                </strong>{" "}
                to <strong>{teams.find((t) => String(t.id) === teamId)?.name || "Unknown"}</strong>.
              </p>
