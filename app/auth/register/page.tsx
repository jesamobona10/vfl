...
export default function RegisterPage() {
  ...
  const orgTypes: { type: OrgType; label: string; icon: typeof School; desc: string }[] = [
    ...
    },
    {
      ...
      icon: Building2,
      desc: "Age-group teams, tournament participation",
    },
        ...
        <div className="card p-6">
          ...
          {step === "details" && (
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                <label htmlFor="register-org" className="block text-sm font-medium mb-1">Organization Name</label>
                <input
                  id="register-org"
                  type="text"
                  value={orgName}
              ...
              <div>
                <label htmlFor="register-email" className="block text-sm font-medium mb-1">Admin Email</label>
                <input
                  id="register-email"
                  type="email"
                  value={email}
