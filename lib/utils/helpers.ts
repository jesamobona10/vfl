...
import type { Team as AppTeam } from "@/lib/types";

/** Minimal team type used for display helpers (name, logo, color). */
export interface Team extends Pick<AppTeam, "id" | "name" | "logo_url"> {
  color?: string;
}
